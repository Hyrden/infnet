...
import br.edu.infnet.AppOrderProduct.controller.AccountController;
...
public class AccountTest implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		AccountController.insertAcc(acc);
		Account acc2 = DataFactory.createAccount(id++,LocalDate.of(1959,1,15), "Francisca Carla Ana Campos", "89622147844",
				"francisca@qualitest.com.br", "Avenida Frei Damião","588", "AP 404", "SP", "Campinas", 
				"13058-181", "BRAZIL");		
		System.out.println("Account - "+acc2);
		AccountController.insertAcc(acc2);
		Account acc3 = DataFactory.createAccount(id++,LocalDate.of(1997,11,8), "Gabrielly Sueli Giovana Baptista", "47736658404",
				"gabriellysuelibaptista@usa.com", "Rua Três","872", "AP 404", "PE", "Petrolina", 
				"13058-181", "BRAZIL");			
		System.out.println("Account - "+acc3);
		AccountController.insertAcc(acc3);
	}
